...
SCRIPTS = [
    ...
    },
    {
        ...
        "category": "邮箱注册",
        "title": "解锁被锁 Outlook",
        "desc": "从资产扫描结果读取待解锁或 RT 过期账号，批量恢复并同步状态。",
        "args": [
            ...
            {"flag": "--statuses", "type": "multi",
             "choices": ["unlock", "expired", "banned"],
             "default": ["unlock", "expired"],
             "help": "自动模式处理的资产状态；封禁账号需手动勾选"},
        ],
    },
    {
        ...
        "desc": "为 RT 过期或缺少 RT 的 Outlook 重新提取 Graph token，并回写主邮箱池。",
        "args": [
            {"flag": "accounts_file", "type": "str", "default": "", "positional": True,
             "help": "账号文件(每行 email----password----...；留空读取资产状态及解锁结果)"},
            ...
            {"flag": "--statuses", "type": "multi",
             "choices": ["expired", "unknown", "unlock", "banned"],
             "default": ["expired", "unknown"],
             "help": "自动模式重提 RT 的资产状态；unknown 仅包含缺少 RT 的邮箱"},
        ],
    },
    {
        "id": "mailbox_broker",
