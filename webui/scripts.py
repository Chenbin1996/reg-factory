...
ENV_SCHEMA = [
    ...
    {"group": "指纹浏览器", "tests": [{"target": "bitbrowser", "label": "测试 指纹浏览器连通"}], "items": [
        ...
        {"key": "CUSTOM_BROWSER_API_AUTH_HEADER", "default": "Authorization", "help": "鉴权请求头名称，例如 X-API-Key。"},
        {"key": "CUSTOM_BROWSER_API_AUTH_PREFIX", "default": "Bearer ", "help": "鉴权值前缀；API Key 直传时留空。"},
        {"key": "CUSTOM_BROWSER_API_HEADERS", "secret": True, "help": "可选额外请求头 JSON，例如 {\"X-Client\":\"reg-factory\"}。"},
        {"key": "CUSTOM_BROWSER_API_TIMEOUT", "type": "int", "default": "60", "help": "单次自定义浏览器 API 请求超时秒数。"},
        {"key": "CUSTOM_BROWSER_API_VERIFY_TLS", "type": "bool", "default": True, "help": "HTTPS API 是否校验证书。"},
        {"key": "CUSTOM_BROWSER_API_ID_FIELD", "default": "id", "help": "generic API 的 profile ID 字段名。路径可使用 {id} 或 {profile_id}。"},
        {"key": "CUSTOM_BROWSER_API_HEALTH_PATH", "default": "/health", "help": "连通性测试优先请求的健康检查路径。"},
        {"key": "CUSTOM_BROWSER_API_CREATE_PATH", "default": "/browser/update", "help": "创建 profile 的路径。"},
        {"key": "CUSTOM_BROWSER_API_LIST_PATH", "default": "/browser/list", "help": "profile 列表路径。"},
        {"key": "CUSTOM_BROWSER_API_OPEN_PATH", "default": "/browser/open", "help": "启动 profile 并返回 CDP ws/cdp/endpoint 的路径。"},
        {"key": "CUSTOM_BROWSER_API_CLOSE_PATH", "default": "/browser/close", "help": "关闭 profile 的路径。"},
        {"key": "CUSTOM_BROWSER_API_DELETE_PATH", "default": "/browser/delete", "help": "删除 profile 的路径。"},
        {"key": "CUSTOM_BROWSER_API_UPDATE_PATH", "default": "/browser/update/partial", "help": "更新指纹的路径。"},
        {"key": "CUSTOM_BROWSER_API_CREATE_METHOD", "default": "POST", "help": "创建请求方法，通常为 POST。"},
        {"key": "CUSTOM_BROWSER_API_LIST_METHOD", "default": "POST", "help": "列表请求方法，兼容模式为 POST，REST 常见为 GET。"},
        {"key": "CUSTOM_BROWSER_API_OPEN_METHOD", "default": "POST", "help": "启动请求方法。"},
        {"key": "CUSTOM_BROWSER_API_CLOSE_METHOD", "default": "POST", "help": "关闭请求方法。"},
        {"key": "CUSTOM_BROWSER_API_DELETE_METHOD", "default": "POST", "help": "删除请求方法；REST API 常用 DELETE。"},
        {"key": "CUSTOM_BROWSER_API_UPDATE_METHOD", "default": "POST", "help": "更新指纹请求方法。"},
        {"key": "CUSTOM_BROWSER_API_FORWARD_FIELDS", "type": "bool", "default": False, "help": "generic 模式将额外 profile 字段原样转发。"},
